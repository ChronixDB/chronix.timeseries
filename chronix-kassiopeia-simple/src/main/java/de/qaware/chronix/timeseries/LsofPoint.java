 ...
 */
public class LsofPoint {
    private int index;
    private long timestamp;
    private List<Lsof> value;
     ...
     */
    public LsofPoint(int index, long timestamp, List<Lsof> value) {
        this.index = index;
