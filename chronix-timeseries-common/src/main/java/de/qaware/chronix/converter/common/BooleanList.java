...
public class BooleanList implements Serializable {
     ...
     */
    private static final boolean[] EMPTY_ELEMENT_DATA = {};
    ...
    public BooleanList(int initialCapacity) {
        if (initialCapacity > 0) {
            this.doubles = new boolean[initialCapacity];
    ...
    public BooleanList(boolean[] longs, int size) {
        if (longs == null) {
    ...
    public BooleanList copy() {
        BooleanList v = new BooleanList(size);
    ...
    public boolean set(int index, boolean element) {
        ...
        boolean oldValue = doubles[index];
     ...
     */
    public boolean addAll(boolean[] otherDoubles) {
     ...
     */
    private boolean[] trimToSize(int size, boolean[] elements) {
        boolean[] copy = Arrays.copyOf(elements, elements.length);
    ...
    public boolean equals(Object obj) {
        ...
        BooleanList rhs = (BooleanList) obj;

        boolean[] thisTrimmed = trimToSize(this.size, this.doubles);
        boolean[] otherTrimmed = trimToSize(rhs.size, rhs.doubles);
