 ...
 */
public class StracePoint {
    private int index;
    private long timestamp;
    private Strace value;
     ...
     */
    public StracePoint(int index, long timestamp, Strace value) {
        this.index = index;
    ...
    public boolean equals(Object obj) {
        ...
        StracePoint rhs = (StracePoint) obj;
