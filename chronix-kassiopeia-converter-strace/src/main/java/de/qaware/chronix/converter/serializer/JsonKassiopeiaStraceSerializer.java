 ...
 */
public class JsonKassiopeiaStraceSerializer {
     ...
     */
    public JsonKassiopeiaStraceSerializer() {
     ...
     */
    public byte[] toJson(StraceTimeSeries timeSeries) {
     ...
     */
    public void fromJson(byte[] json, final long queryStart, final long queryEnd, StraceTimeSeries.Builder builder) {
