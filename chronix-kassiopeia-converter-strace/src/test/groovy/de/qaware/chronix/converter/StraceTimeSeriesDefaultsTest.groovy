 ...
 */
class StraceTimeSeriesDefaultsTest extends Specification {

    def "test default group by"() {
        given:
        def straceTimeSeries = new StraceTimeSeries.Builder("metric").build();
    ...
    def "test default reduce"() {
        ...
        given:
        def ts1 = new StraceTimeSeries.Builder("metric")
                ...
                .point(5, "10")
                .build();
        def ts2 = new StraceTimeSeries.Builder("metric")
        ...
        list.containsAll([new StracePoint(0, 1, "2"), new StracePoint(1, 2, "4"), new StracePoint(2, 3, "6")
                          , new StracePoint(3, 4, "8"), new StracePoint(4, 5, "10"), new StracePoint(5, 6, "12")])
