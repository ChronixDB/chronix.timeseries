 ...
 */
public class JsonKassiopeiaNumericSerializer {

    public static final String UTF_8 = "UTF-8";

    private static final Logger LOGGER = LoggerFactory.getLogger(JsonKassiopeiaNumericSerializer.class);
    private static final byte[] EMPTY_JSON = "[[],[]]".getBytes(Charset.forName(UTF_8));
    private final Gson gson;

    /**
     * Constructs a new JsonKassiopeiaNumericSerializer.
     */
    public JsonKassiopeiaNumericSerializer() {
