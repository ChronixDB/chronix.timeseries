...
/**
 * Class to easily convert the protocol buffer into NumericPoint<Long,Double>
 *
 * @author f.lautenschlager
 */
public final class ProtoBufKassiopeiaNumericSerializer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ProtoBufKassiopeiaNumericSerializer.class);
    private static final long ALMOST_EQUALS_OFFSET_MS = Long.parseLong(System.getProperty(DATE_EQUALS_OFFSET_MS, "10"));

    /**
     * Private constructor
     */
    private ProtoBufKassiopeiaNumericSerializer() {
        //utility class
    }
     ...
     */
    public static byte[] to(Iterator<NumericPoint> metricDataPoints) {
        long previousDate = 0;
        ...
        while (metricDataPoints.hasNext()) {
            ...
            NumericPoint p = metricDataPoints.next();
