 ...
 */
public final class ProtoBufKassiopeiaStringSerializer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ProtoBufKassiopeiaStringSerializer.class);
